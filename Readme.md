...
Задача 2
 Файл с изображением блок-схемы находится в finish.png
задача 3
 Пользователь указывает сколько элементов (N) он хочеть задать и зопалняет стартовый массив элементами в цикле N-раз.
